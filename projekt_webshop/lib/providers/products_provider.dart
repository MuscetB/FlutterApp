...
import 'package:projekt_webshop/models/product_model.dart';
...
class ProductsProvider with ChangeNotifier {
  ...
  ProductModel? findByProdId (String productId) {
    // If provjeru radimo u slučaju da se produkt ne pronađe funkcija će završiti sa null, da nemamo toga u slučaju kada
    // product ne može biti pronađen aplikacija bi izbacila grešku
  ...
  // funkcija za pretraživanje na search screenu
  List<ProductModel> searchQuery ({required String searchText, required List<ProductModel> passedList}){
    List<ProductModel> searchList = passedList
        .where((element) =>
            element.productCategory.toLowerCase().contains(searchText.toLowerCase()))
        .toList();
        return searchList;
  }
