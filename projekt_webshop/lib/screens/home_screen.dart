...
import 'package:projekt_webshop/consts/app_constants.dart';
...
import 'package:projekt_webshop/widgets/products/ctg_rounded_widget.dart';
import 'package:projekt_webshop/widgets/products/latest_arrival.dart';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: Swiper(
                    autoplay:
                        true, // automatska promjena reklama na počenom ekranu
              ...
              const TitlesTextWidget(label: "Categoryes"),
              const SizedBox(
                height: 15.0,
              ),
              GridView.count(
