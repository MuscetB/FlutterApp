...
import 'package:projekt_webshop/models/cart_model.dart';
...
import 'package:projekt_webshop/screens/cart/quantity_btm_sheet.dart';
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Column( // X ikonica za uklanjanje određenog proizvoda iz košarice
                          children: [
                            IconButton(
                              onPressed: () async{
                    ...
                    Row(
                      //red u kojem su cijena i količina proizvoda
                      // mainAxisAlignment: MainAxisAlignment.spaceBetween, // s ovim odvajamo cijenu od količin
                      children: [
                        SubtitleTextWidget(
                          label: "${getCurrProduct.productPrice}\$",
                          color: Colors.blue,
                        ),
                        const Spacer(), // radi isto što i mainAxisAligment
                        OutlinedButton.icon(
                          onPressed: () async {
