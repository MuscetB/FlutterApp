...
class _SearchScreenState extends State<SearchScreen> {
  ...
  List<ProductModel> productListSearch = []; //lista kreirana zbog pretraživanja artikala kako bi pretraživane artikle mogli spremiti u nju da nam ne poremeti productList listu
